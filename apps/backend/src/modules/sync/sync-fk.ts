...
export const ENTITY_FK_MAP: Partial<Record<SyncEntityName, SyncFkRef[]>> = {
  ...
  Delivery: [
    ...
    { uuidField: 'carrierUuid', idField: 'carrierId', parent: 'Carrier', required: false },
  ],
  DeliveryItem: [
  ...
  ProductionFlow: [
    ...
    {
      uuidField: 'workerOutputUuid',
      idField: 'workerOutputId',
      parent: 'ProductionWorkerOutput',
      required: false,
    },
    { uuidField: 'createdByUuid', idField: 'createdById', parent: 'User', required: false },
  ],
  ...
  ProductionWorkerOutput: [
    { uuidField: 'workerUuid', idField: 'workerId', parent: 'ProductionWorker', required: true },
    { uuidField: 'departmentUuid', idField: 'departmentId', parent: 'Department', required: true },
    { uuidField: 'productUuid', idField: 'productId', parent: 'Product', required: true },
    {
      uuidField: 'productionSessionUuid',
  ...
  CarrierRate: [
    { uuidField: 'carrierUuid', idField: 'carrierId', parent: 'Carrier', required: true },
    { uuidField: 'productUuid', idField: 'productId', parent: 'Product', required: true },
  ],
  CarrierTrip: [
    { uuidField: 'carrierUuid', idField: 'carrierId', parent: 'Carrier', required: true },
    { uuidField: 'departmentUuid', idField: 'departmentId', parent: 'Department', required: true },
    { uuidField: 'deliveryUuid', idField: 'deliveryId', parent: 'Delivery', required: false },
    { uuidField: 'deliveryDropUuid', idField: 'deliveryDropId', parent: 'DeliveryDrop', required: false },
    { uuidField: 'internalTransferUuid', idField: 'internalTransferId', parent: 'InternalTransfer', required: false },
    { uuidField: 'productUuid', idField: 'productId', parent: 'Product', required: true },
    { uuidField: 'createdByUuid', idField: 'createdById', parent: 'User', required: false },
  ],
  PurchaseOrder: [
