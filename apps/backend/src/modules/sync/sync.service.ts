...
export class SyncService {
  ...
  private delegate(entity: SyncEntityName): Delegate {
    const map: Record<SyncEntityName, Delegate> = {
      ...
      DonationBeneficiary: this.prisma.donationBeneficiary as unknown as Delegate,
      Donation: this.prisma.donation as unknown as Delegate,
      DonationItem: this.prisma.donationItem as unknown as Delegate,
