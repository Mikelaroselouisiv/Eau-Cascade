...
export const PERMISSIONS = [
  ...
  { code: 'workers.manage', label: 'Créer et modifier les ouvriers de production' },
  { code: 'carriers.manage', label: 'Créer et modifier les transporteurs' },
  ...
  { code: 'donation.view', label: 'Consulter les dons et bénéficiaires' },
  { code: 'donation.manage', label: 'Enregistrer des dons (stock, sans encaissement)' },
